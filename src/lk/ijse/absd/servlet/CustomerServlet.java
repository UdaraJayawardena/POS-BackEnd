...
public class CustomerServlet extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("id : " + cus.getString("id"));

        if (cus.getString("id") != null) {
...
//                System.out.println("id : " + cus.getString("id"));
//                System.out.println("name : " + cus.getString("name"));
//                System.out.println("address : " + cus.getString("address"));
//                System.out.println("salary : " + cus.getString("salary"));

                String id = cus.getString("id");
